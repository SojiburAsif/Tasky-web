...
const Login = () => {
    const { loginUser, googleSingIn } = use(AuthContext);
    ...
    const handleGoogleSignIn = () => {
        ...
        googleSingIn()
            .then((result) => {
                ...
                console.log("Google user:", result.user); // optional: debug
            })
            .catch((err) => {
    ...
    return (
        <div className="min-h-screen flex items-center font-display justify-center bg-gray-100 dark:bg-gray-900">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:text-purple-500 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-100"
                        />
                    </div>
                    ...
                    <div>
                        <button
                            type="submit"
                            className="w-full cursor-pointer  flex justify-center px-4 py-2 text-sm font-medium text-white bg-purple-700 rounded-md focus:outline-nonefocus:text-purple-100"
                        >
                            Sign In
                        </button>
                    </div>
